...
class PoptatoDataStore(context: Context) {
    ...
    val todoCompletionCount: Flow<Int> = dataStore.data.map { preferences ->
        preferences[TODO_COMPLETION_KEY] ?: 0
    }
    ...
    suspend fun setTodoCompletionCount(count: Int) {
        dataStore.edit { preferences ->
            preferences[TODO_COMPLETION_KEY] = count
        }
    }
    ...
    companion object {
        ...
        val TODO_COMPLETION_KEY = intPreferencesKey("todo_completion")
    }
}